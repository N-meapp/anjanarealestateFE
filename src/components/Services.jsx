export default function Services(){
    return(
        <div className="md:flex gap-5 pt-10 px-10 pb-10 bg-[#e1b400] mb-20">
            <div className="features-icon w-full bg-[#faffe6] pt-10 md:pt-0 mb-10 pb-10 md:mb-0 ">
            <img className=" w-[20%] mt-8" src="./src/assets/ourproperties.png"></img>
            <h1 className="mt-5 font-bold text-lg text-[#e1b400]">Our properties</h1>
            ...
            <h1 className="mt-5 font-bold text-lg text-[#e1b400]">Properties for Sale</h1>
            ...
            <h1 className="mt-5 font-bold text-lg text-[#e1b400]">Real Estate Agent</h1>
            ...
            <h1 className="mt-5 font-bold text-lg text-[#e1b400]">House For Sale</h1>
