    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        >
          ...
          <a href="/all-category-list"  className="flex items-center">
             Properties
          </a>
      ...
      >
        ...
        <a href="/about-page" className="flex items-center">
          About
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a href="gallery-page" className="flex items-center">
          Gallery
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a href="contact-page" className="flex items-center">
          Contact
        </a>
      </Typography>
