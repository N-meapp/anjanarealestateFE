...
//  }
  ...
  return (
    <div>   
      ...
      <div className="grid grid-cols-2 gap-2 px-[150px]">


  <div className="relative flex flex-col md:flex-row w-full my-6 bg-white shadow-sm border border-slate-200 rounded-xl">
